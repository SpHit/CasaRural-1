namespace CasaRural.Migrations
{
    ...
    public partial class Initial : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        llogaterId = c.String(),
                        llogater_NIF = c.String(maxLength: 128),
                    })
                .PrimaryKey(t => t.IdReserva)
                .ForeignKey("dbo.Llogaters", t => t.llogater_NIF)
                .Index(t => t.llogater_NIF);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Reservas", "llogater_NIF", "dbo.Llogaters");
            ...
            DropIndex("dbo.Reservas", new[] { "llogater_NIF" });
